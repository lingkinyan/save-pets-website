...
function QuarterTableComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(3, QuarterTableComponent_Conditional_1_For_4_Template, 2, 2, "th", 4, ɵɵrepeaterTrackByIdentity);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function QuarterTableComponent_For_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(2, QuarterTableComponent_For_4_For_3_Template, 3, 3, "td", 6, _forTrack0);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const row_r3 = ctx.$implicit;
...
_QuarterHeaderComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function QuarterHeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵelementEnd();
      ɵɵelementStart(5, "div");
      ɵɵrepeaterCreate(6, QuarterHeaderComponent_For_7_Template, 2, 5, "button", 3, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵelementStart(8, "button", 0);
...
_QuarterTableComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function QuarterTableComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵelementStart(2, "tbody");
      ɵɵrepeaterCreate(3, QuarterTableComponent_For_4_Template, 4, 2, "tr", 1, _forTrack0);
      ɵɵelementEnd()();
    }
    if (rf & 2) {
      ɵɵadvance();
...
_NzQuarterPickerComponent.ɵfac = function NzQuarterPickerComponent_Factory(t) {
  return new (t || _NzQuarterPickerComponent)(ɵɵdirectiveInject(NzDatePickerComponent, 9));
};
