...
import {
  DomSanitizer
} from "./chunk-O2G52X7R.js";
import {
  HttpBackend,
  HttpClient
} from "./chunk-L3C42KXZ.js";
import {
  DOCUMENT
...
function generate2(color) {
  ...
  for (var i = lightColorCount2; i > 0; i -= 1) {
    var hsv = toHsv2(pColor);
    var colorString = toHex2(inputToRGB({
  ...
  for (var _i = 1; _i <= darkColorCount2; _i += 1) {
    var _hsv = toHsv2(pColor);
    var _colorString = toHex2(inputToRGB({
      h: getHue2(_hsv, _i),
  ...
  if (opts.theme === "dark") {
    return darkColorMap2.map(function(_ref3) {
      var index = _ref3.index, opacity = _ref3.opacity;
      var darkColorString = toHex2(mix2(inputToRGB(opts.backgroundColor || "#141414"), inputToRGB(patterns[index]), opacity * 100));
      return darkColorString;
    });
  }
  return patterns;
...
Object.keys(presetPrimaryColors).forEach(function(key) {
  presetPalettes[key] = generate2(presetPrimaryColors[key]);
  presetPalettes[key].primary = presetPalettes[key][5];
  presetDarkPalettes[key] = generate2(presetPrimaryColors[key], {
    theme: "dark",
...
//# sourceMappingURL=chunk-6KKAMSZL.js.map
