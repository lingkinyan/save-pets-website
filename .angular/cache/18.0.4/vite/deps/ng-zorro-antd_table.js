import {
  ...
  NzSelectComponent,
  NzSelectModule
} from "./chunk-4E5TUHUX.js";
import {
  NzCheckboxComponent,
  NzCheckboxModule
} from "./chunk-3WIJGU5L.js";
import {
  NzFormStatusService
...
import {
  NzMenuDirective,
  NzMenuItemComponent
} from "./chunk-T62U7GVB.js";
import "./chunk-TVCGEDR7.js";
...
function NzTableFixedRowComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵstyleProp("width", ɵɵpipeBind1(1, 2, ctx_r0.hostWidth$), "px");
  }
}
...
var _c11 = ["tableHeaderElement"];
var _c122 = ["tableBodyElement"];
var _c132 = (a0, a1) => ({
  $implicit: a0,
  index: a1
});
...
function NzTableInnerScrollComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelement(2, "table", 4);
    ɵɵelementEnd();
    ɵɵtemplate(3, NzTableInnerScrollComponent_Conditional_0_Conditional_3_Template, 3, 4, "div", 5)(4, NzTableInnerScrollComponent_Conditional_0_Conditional_4_Template, 5, 9, "cdk-virtual-scroll-viewport", 6);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
_NzTableContentComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 5,
  vars: 2,
  consts: [[3, "width", "minWidth"], [1, "ant-table-thead"], [3, "ngTemplateOutlet"]],
  template: function NzTableContentComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵrepeaterCreate(0, NzTableContentComponent_For_1_Template, 1, 4, "col", 0, ɵɵrepeaterTrackByIdentity);
...
_NzTableFixedRowComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 5,
  vars: 3,
  consts: [["tdElement", ""], [1, "nz-disable-td", "ant-table-cell"], [1, "ant-table-expanded-row-fixed", 2, "position", "sticky", "left", "0", "overflow", "hidden", 3, "width"], [1, "ant-table-expanded-row-fixed", 2, "position", "sticky", "left", "0", "overflow", "hidden"]],
  template: function NzTableFixedRowComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c9);
      ɵɵelementStart(0, "td", 1, 0);
      ɵɵtemplate(2, NzTableFixedRowComponent_Conditional_2_Template, 3, 4, "div", 2);
      ɵɵpipe(3, "async");
      ɵɵtemplate(4, NzTableFixedRowComponent_Conditional_4_Template, 1, 0);
      ɵɵelementEnd();
    }
    if (rf & 2) {
      ɵɵadvance(2);
...
_NzTrMeasureComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NzTrMeasureComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵrepeaterCreate(0, NzTrMeasureComponent_For_1_Template, 2, 0, "td", 1, ɵɵrepeaterTrackByIdentity);
    }
    if (rf & 2) {
...
_NzTableComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NzTableComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(4, NzTableComponent_Conditional_4_Template, 1, 1, "nz-table-title-footer", 6)(5, NzTableComponent_Conditional_5_Template, 1, 14, "nz-table-inner-scroll", 7)(6, NzTableComponent_Conditional_6_Template, 1, 4, "nz-table-inner-default", 8)(7, NzTableComponent_Conditional_7_Template, 1, 1, "nz-table-title-footer", 9);
      ɵɵelementEnd();
