...
import { NzFormDirective, NzLabelAlignType } from './form.directive';
...
export declare class NzFormLabelComponent implements OnDestroy {
    ...
    private labelWrap;
    private destroy$;
    constructor(cdr: ChangeDetectorRef, nzFormDirective: NzFormDirective);
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NzFormLabelComponent, [null, { optional: true; skipSelf: true; }]>;
