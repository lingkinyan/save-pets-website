...
export declare class NzAutocompleteComponent implements AfterContentInit, AfterViewInit, OnDestroy, OnInit, OnChanges {
    ...
    constructor(changeDetectorRef: ChangeDetectorRef, directionality: Directionality, noAnimation?: NzNoAnimationDirective | undefined);
    ngOnInit(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NzAutocompleteComponent, [null, { optional: true; }, { optional: true; host: true; }]>;
