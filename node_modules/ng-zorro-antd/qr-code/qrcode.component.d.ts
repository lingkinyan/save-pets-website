...
export declare class NzQRCodeComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    isBrowser: boolean;
    private destroy$;
    constructor(i18n: NzI18nService, el: ElementRef, cdr: ChangeDetectorRef, platformId: Object);
    ngOnInit(): void;
