...
export declare class NzCarouselComponent implements AfterContentInit, AfterViewInit, OnDestroy, OnChanges, OnInit {
    ...
    private isDragging;
    constructor(elementRef: ElementRef, nzConfigService: NzConfigService, ngZone: NgZone, renderer: Renderer2, cdr: ChangeDetectorRef, platform: Platform, resizeService: NzResizeService, nzDragService: NzDragService, nzResizeObserver: NzResizeObserver, directionality: Directionality, customStrategies: NzCarouselStrategyRegistryItem[]);
    ngOnInit(): void;
    ...
    layout(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NzCarouselComponent, [null, null, null, null, null, null, null, null, null, { optional: true; }, { optional: true; }]>;
