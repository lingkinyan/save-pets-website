...
export class ProcedureComponent extends IntersectionComponents {
  ...
  stepList = [
    ...
    },
    {
      ...
      content:
        "Once you have selected your preferred animal, fill out an <a href='https://www.petsaveorg.com/adopt/application-form' target='_blank' class='font-bold underline'>application form</a>, also found at the end of each animal’s description, to state your interest. <br>Due to the volume of applications we get, it may take up to 2 weeks for us to process the applications. <br>Again, you will only hear back from us if you have been selected to move on to step 3: home visit.",
    },
    {
